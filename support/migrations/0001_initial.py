    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone3', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='support.issuecategory')),
